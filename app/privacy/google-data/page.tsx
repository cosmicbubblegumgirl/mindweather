  ...
  return <main className="privacy-page">
    ...
    <article className="privacy-page__content">
      ...
      <div className="privacy-page__grid">
        ...
        <section><ShieldCheck /><h2>How it is used</h2><ul><li>To create or open your secure MindWeather account.</li><li>To show meetings, events and Meet links beside your study plan.</li><li>To let you open the original event or join its meeting.</li></ul><p>Your Google information is not sold, shared for advertising, or used for unrelated profiling.</p></section>
        ...
        <section><Database /><h2>Storage and sharing</h2><p>Your Google account identifier, name and email are stored in Supabase Auth and your protected profile. Upcoming Calendar event details and the connected email are cached only in your browser. Calendar requests go directly from your browser to Google.</p></section>
        <section><Trash2 /><h2>Deletion and your choices</h2><p>Signing out closes the account session but does not delete study data. Choosing <strong>Disconnect</strong> revokes the current Google Calendar token and clears cached Calendar data. You can clear your study workspace in Settings and remove MindWeather from your Google account connections at any time.</p><p>Information received from Google APIs is handled under the Google API Services User Data Policy, including the Limited Use requirements.</p></section>
      </div>
