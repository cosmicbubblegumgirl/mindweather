    ...
    <div className="wellbeing-page">
      ...
      <section className="anxiety-relief panel" aria-labelledby="anxiety-relief-title">
        <header className="anxiety-relief__header">
          ...
          <div className="anxiety-relief__privacy"><ShieldCheck /> Stays on this device</div>
        </header>
      ...
      {state.wellbeingCheckins.length > 0 && <p className="wellbeing-history"><ShieldCheck /> {state.wellbeingCheckins.length} private check-ins saved on this device.</p>}
