...
import { CalendarDays, CloudSun, Focus, ListTodo, Settings, WifiOff } from "lucide-react";
  ...
  return (
    <main className={`app-shell simple-shell app-shell--${state.currentWeather} theme--${state.preferences.theme} ${state.preferences.largeText ? "is-large-text" : ""} ${state.preferences.highContrast ? "is-high-contrast" : ""}`}>
      ...
      <section className="app-main simple-main">
        {offline && <div className="offline-banner"><WifiOff size={14} /><span>You’re offline. Your changes are still saved on this device.</span></div>}
